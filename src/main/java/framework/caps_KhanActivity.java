...
public class caps_KhanActivity {
	...
	public static AndroidDriver<AndroidElement> caps_KhanAcd(String deviceName,String platformName,String appPackage,String appActivity) throws IOException, InterruptedException
	{
FileReader fr=new FileReader(System.getProperty("user.dir")+"//src//main//java//glob.properties");
